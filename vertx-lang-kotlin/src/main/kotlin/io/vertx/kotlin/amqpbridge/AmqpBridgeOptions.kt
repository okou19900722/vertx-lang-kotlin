...
/**
 * A function providing a DSL for building [AmqpBridgeOptions] objects.
 *
 *  Options for configuring the AmqpBridge.
 *
 *
 * <p/>
 * NOTE: This function has been automatically generated from the [AmqpBridgeOptions original] using
    Vert.x codegen.
 *
 * @param connectTimeout  Set the connect timeout
 * @param containerId  Sets the value to use as the container-id field in the AMQP Open frame. Some
    servers and clients use this for the concept of a 'Client ID'. Defaults to null, which indicates
    a value will be generated by the bridge when the underlying connection is made.
 ...
 * @param idleTimeout  Set the idle timeout, default time unit is seconds. Zero means don't timeout.
    ...
    timeout. If you want change default time unit, use [io.vertx.amqpbridge.AmqpBridgeOptions]
 ...
 * @param replyHandlingSupport  Sets whether the bridge should try to enable support for sending
    messages with a reply handler set, and replying to messages using the message reply methods.
    Defaults to true. If the server does not advertise support for 'anonymous sender' links then the
    bridge won't support reply handling regardless of this setting.
 ...
 * @param vhost  Sets the value to use as the hostname field in the AMQP Open frame. Defaults to
    null, which indicates the hostname value given when starting the bridge will be used to populate
    the hostname field.
 */
