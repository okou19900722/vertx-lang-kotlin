...
/**
 * A function providing a DSL for building [HttpServerOptions] objects.
 *
 *  Represents options used by an [io.vertx.core.http.HttpServer] instance
 *
 *
 * <p/>
 * NOTE: This function has been automatically generated from the [HttpServerOptions original] using
    Vert.x codegen.
 *
 ...
 * @param maxChunkSize  Set the maximum HTTP chunk size that [io.vertx.core.http.HttpServerRequest]
    will receive
