...
/**
 * A function providing a DSL for building [OpenOptions] objects.
 *
 *  Describes how an [io.vertx.core.file.AsyncFile] should be opened.
 *
 *
 * <p/>
 * NOTE: This function has been automatically generated from the [OpenOptions original] using Vert.x
    codegen.
 *
 ...
 * @param deleteOnClose  Set whether the file should be deleted when it's closed, or the JVM is
    shutdown.
 * @param dsync  Set whether every write to the file's content  ill be written synchronously to the
    underlying hardware.
 ...
 * @param sync  Set whether every write to the file's content and meta-data will be written
    synchronously to the underlying hardware.
 * @param truncateExisting  Set whether the file should be truncated to zero length on opening if it
    exists and is opened for write
...
@Deprecated(
    ...
    ReplaceWith("openOptionsOf(append,create,createNew,deleteOnClose,dsync,perms,read,sparse,sync,truncateExisting,write)")
)
fun OpenOptions(
  append: Boolean? = null,
  create: Boolean? = null,
