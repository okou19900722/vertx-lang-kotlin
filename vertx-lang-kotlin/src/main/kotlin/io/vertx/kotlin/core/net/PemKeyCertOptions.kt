...
/**
 * A function providing a DSL for building [PemKeyCertOptions] objects.
 *
 ...
 *  <p>
 *
 *  A key file must contain a <b>non encrypted</b> private key in <b>PKCS8</b> format wrapped in a
    PEM
 *  block, for example:
 *  <p>
 *
 ...
 *
 * <p/>
 * NOTE: This function has been automatically generated from the [PemKeyCertOptions original] using
    Vert.x codegen.
 *
 ...
 * @param certValue  Set the first certificate as a buffer, replacing the previous certificates
    buffers
...
fun pemKeyCertOptionsOf(
  ...
  certValue: Buffer? = null,
  certValues: Iterable<Buffer>? = null,
  keyPath: String? = null,
  keyPaths: Iterable<String>? = null,
  keyValue: Buffer? = null,
  keyValues: Iterable<Buffer>? = null
) = PemKeyCertOptions()
.apply {
  if (certPath != null) {
...
@Deprecated(
    ...
    ReplaceWith("pemKeyCertOptionsOf(certPath,certPaths,certValue,certValues,keyPath,keyPaths,keyValue,keyValues)")
)
