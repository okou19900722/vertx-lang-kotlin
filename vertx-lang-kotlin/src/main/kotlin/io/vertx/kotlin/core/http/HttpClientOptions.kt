...
/**
 * A function providing a DSL for building [HttpClientOptions] objects.
 *
 *  Options describing how an [io.vertx.core.http.HttpClient] will make connections.
 *
 *
 * <p/>
 * NOTE: This function has been automatically generated from the [HttpClientOptions original] using
    Vert.x codegen.
 *
 ...
 * @param http2ConnectionWindowSize  Set the default HTTP/2 connection window size. It overrides the
    initial window size set by [io.vertx.core.http.Http2Settings], so the connection window size is
    greater than for its streams, in order the data throughput. <p/> A value of <code>-1</code>
