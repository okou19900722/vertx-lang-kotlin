...
/**
 * A function providing a DSL for building [EventBusOptions] objects.
 *
 *  Options to configure the event bus.
 *
 *
 * <p/>
 * NOTE: This function has been automatically generated from the [EventBusOptions original] using
    Vert.x codegen.
 *
 ...
 * @param clusterPublicHost  Set the public facing hostname to be used for clustering. Sometimes,
    ...
    from the hostname the server listens at. <p> The default value is null which means use the same
    as the cluster hostname.
 ...
 * @param idleTimeout  Set the idle timeout, default time unit is seconds. Zero means don't timeout.
    ...
    timeout. If you want change default time unit, use [io.vertx.core.net.TCPSSLOptions]
