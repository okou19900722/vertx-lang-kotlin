...
/**
 * A function providing a DSL for building [OAuth2ClientOptions] objects.
 *
 *  Options describing how an OAuth2  will make connections.
 *
 *
 * <p/>
 * NOTE: This function has been automatically generated from the [OAuth2ClientOptions original]
 ...
 * @param alpnVersions  Set the list of protocol versions to provide to the server during the
    ...
    effort list according to [io.vertx.core.http.HttpClientOptions]: <ul>   <li>: [ "h2", "http/1.1"
    ]</li>   <li>otherwise: [[io.vertx.core.http.HttpClientOptions]]</li> </ul>
 ...
 * @param idleTimeout  Set the idle timeout, default time unit is seconds. Zero means don't timeout.
    ...
    timeout. If you want change default time unit, use [io.vertx.core.http.HttpClientOptions]
 ...
 * @param useBasicAuthorizationHeader  Flag to use HTTP basic auth header with client id, client
    secret.
...
fun oAuth2ClientOptionsOf(
  ...
  extraParameters: JsonObject? = null,
  ...
  userInfoParameters: JsonObject? = null,
