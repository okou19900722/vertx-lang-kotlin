...
/**
 * A function providing a DSL for building [WebClientOptions] objects.
 *
 *
 *
 * <p/>
 * NOTE: This function has been automatically generated from the [WebClientOptions original] using
    Vert.x codegen.
 *
 * @param alpnVersions  Set the list of protocol versions to provide to the server during the
    ...
    effort list according to [io.vertx.ext.web.client.WebClientOptions]: <ul>   <li>: [ "h2",
 ...
 * @param idleTimeout  Set the idle timeout, default time unit is seconds. Zero means don't timeout.
    This determines if a connection will timeout and be closed if no data is received within the
    timeout. If you want change default time unit, use [io.vertx.ext.web.client.WebClientOptions]
